...
//
//        try {
//            objectParser.writeValue(new File("testing-resources/expectedPrintNodeCreation.json"), node);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//
//        try {
//            boolean result =
//                    checkNodeMatchesFileResult(node, "testing-resources/expectedPrintNodeCreation.json");
//            Assert.assertTrue(result);
//        } catch (Exception e) {
//            e.printStackTrace();
//            Assert.assertEquals(false, true);
